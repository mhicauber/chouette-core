...
RSpec.describe Import::Gtfs do
  ...
  describe "#import_stop_times" do
    ...
    it "should create a VehicleJourneyAtStop for each stop_time" do
      ...
      expected_attributes = [
        ['STAGECOACH', 0, t('2000-01-01 06:00:00 UTC'), t('2000-01-01 06:00:00 UTC'),0,1],
        ['BEATTY_AIRPORT', 1, t('2000-01-01 06:20:00 UTC'), t('2000-01-01 06:20:00 UTC'),1,1],
        ['STAGECOACH', 0, t('2000-01-01 06:00:00 UTC'), t('2000-01-01 06:00:00 UTC'),0,0],
        ['NANAA', 1, t('2000-01-01 06:07:00 UTC'), t('2000-01-01 06:05:00 UTC'),0,0],
        ['NADAV', 2, t('2000-01-01 06:14:00 UTC'), t('2000-01-01 06:12:00 UTC'),0,0],
        ['DADAN', 3, t('2000-01-01 06:21:00 UTC'), t('2000-01-01 06:19:00 UTC'),0,0],
        ['EMSI', 4, t('2000-01-01 06:28:00 UTC'), t('2000-01-01 06:26:00 UTC'),0,0],
        ...
        ['AMV', 0, t('2000-01-01 10:00:00 UTC'), t('2000-01-01 10:00:00 UTC'),0,0],
        ['BEATTY_AIRPORT', 1, t('2000-01-01 11:00:00 UTC'), t('2000-01-01 11:00:00 UTC'),0,0],
