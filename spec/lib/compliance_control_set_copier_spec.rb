  ...
  context 'Copying empty set' do
    ...
    context 'correct organisation' do
      ...
      context 'Directed Acyclic Graph is copied correctly' do
        let(:cc_blox){
          3.times.map{ |n| create :compliance_control_block, compliance_control_set: cc_set, transport_mode: NetexTransportModeEnumerations.transport_modes[n], transport_submode: StifTransportSubmodeEnumerations.transport_submodes[n] }
        }
        let!(:direct_ccs){
