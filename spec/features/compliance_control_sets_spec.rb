RSpec.describe "ComplianceControlSets", type: :feature do
  ...
  let(:blox){
    2.times.map{ |n| create :compliance_control_block, compliance_control_set: control_set, transport_mode: NetexTransportModeEnumerations.transport_modes[n], transport_submode: StifTransportSubmodeEnumerations.transport_submodes[n] }
  }
