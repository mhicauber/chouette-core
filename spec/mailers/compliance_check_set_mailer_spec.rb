...
RSpec.describe MergeMailer, type: :mailer do
  ...
  it 'should have correct body' do
    expect(email.body).to have_content I18n.t("mailers.compliance_check_set_mailer.finished.body", ref_name: ccset.referential.name, status: I18n.t("statuses.#{ccset.status}"))
  end
end
